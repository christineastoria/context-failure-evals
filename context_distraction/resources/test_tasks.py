...
TEST_TASKS = [
    ...
    },
    {
        ...
        "recall_questions": [
            ...
            f"What was the strategic priority ranking for quantum computing among all domains in your final analysis? (Expected: Rank {get_strategic_priority_rank('quantum_computing')})",
